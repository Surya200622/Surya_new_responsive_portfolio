      ...
      <div className="container">
          ...
          <div className="footer__links">
            ...
            {LEGAL_LINKS.map(link => {
              ...
              return (
                ...
                >
                  <IconComp size={14} />
                  {link.label === 'Privacy Policy' ? "Privacy Policy" : "Terms of Service"}
                </Link>
              );
            })}
          </div>
        ...
        <div className="footer__bottom">
          ...
          <div className="footer__bottom-links">
            <Link href="/privacy-policy" className="footer__bottom-legal-link">{"Privacy Policy"}</Link>
            <span className="footer__bottom-divider">·</span>
            <Link href="/terms-of-service" className="footer__bottom-legal-link">{"Terms of Service"}</Link>
          </div>
