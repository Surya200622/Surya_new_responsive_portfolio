...
export default function AboutSection() {
  ...
  const STORY_BLOCKS = [
    ...
    { title: "My Goal", text: "I'm actively seeking to apply my full-stack web development skills, contribute to innovative projects, and grow professionally. I'm passionate about creating experiences that convert visitors into customers." },
  ];
