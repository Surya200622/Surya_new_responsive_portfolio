...
export default function ClientQuotationsPage() {
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div>
        <h1 className="text-2xl font-display font-bold text-white mb-1">Quotations & Invoices</h1>
      ...
      <div className="glass-card-strong p-12 rounded-2xl border border-[var(--color-glass-border)] text-center mt-6">
        ...
        <h3 className="text-xl font-display font-bold text-white mb-2">No quotations yet</h3>
