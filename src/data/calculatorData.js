...
export const FEATURE_COSTS = {
  adminDashboard: { cost: 1500, timeline: 3, label: 'Admin Dashboard', icon: 'LayoutDashboard' },
  clientDashboard: { cost: 1000, timeline: 2, label: 'Client Dashboard', icon: 'Users' },
  database: { cost: 1250, timeline: 2, label: 'Database Integration', icon: 'Database' },
  paymentGateway: { cost: 750, timeline: 2, label: 'Payment Gateway', icon: 'CreditCard' },
  cms: { cost: 1250, timeline: 2, label: 'CMS Support', icon: 'FileEdit' },
  seo: { cost: 750, timeline: 1, label: 'SEO Optimization', icon: 'Search' },
  hosting: { cost: 250, timeline: 1, label: 'Hosting Setup', icon: 'Server' },
  customAnimations: { cost: 750, timeline: 2, label: 'Custom Animations', icon: 'Sparkles' },
  realtimeChat: { cost: 1500, timeline: 4, label: 'Real-time Chat', icon: 'MessageCircle' },
  analyticsDashboard: { cost: 750, timeline: 2, label: 'Analytics Dashboard', icon: 'BarChart3' },
  apiIntegrations: { cost: 500, timeline: 2, label: 'API Integration', icon: 'Plug' },
  emailIntegration: { cost: 500, timeline: 1, label: 'Email Integration', icon: 'Mail' },
  whatsappIntegration: { cost: 250, timeline: 1, label: 'WhatsApp Integration', icon: 'MessageCircle' },
  googleMaps: { cost: 250, timeline: 1, label: 'Google Maps', icon: 'MapPin' },
  socialMediaSetup: { cost: 1000, timeline: 1, label: 'Social Media Setup', icon: 'Share2' },
  customGraphics: { cost: 375, timeline: 1, label: 'Custom Graphics', icon: 'PenTool' },
  extraPage: { cost: 250, timeline: 1, label: 'Extra Page', icon: 'FilePlus' },
  extraRevision: { cost: 250, timeline: 1, label: 'Extra Revision', icon: 'RefreshCw' },
  promoVideo: { cost: 250, timeline: 1, label: 'Promo Video', icon: 'Video' },
  posters: { cost: 200, timeline: 1, label: 'Poster Design', icon: 'Image' },
  logos: { cost: 375, timeline: 1, label: 'Logo Design', icon: 'Palette' },
  imageFaceswap: { cost: 250, timeline: 1, label: 'Image Face Swap', icon: 'Image' },
  videoFaceswap: { cost: 500, timeline: 1, label: 'Video Face Swap', icon: 'Video' },
};
